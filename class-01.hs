...
{-
   ...
   avg3 45 87 32 = 54.666666666666664;
   avg3 11 8 92 = 37.0;	
...
-- (объясните смысл типовой аннотации: параметр и результат типа а, который принадлежит классу типов Num)
double :: Num a => a -> a
double a = a * 2
...
descrTempF :: Double -> [String]
descrTempF a = map (describeTemperature . f2c) [a]
